...
sub vdr_AlertInfoInitialize { 
  ...
  vdr_AlertInfoAdd($alt_info_HHR, "ambgcd5c", "feature",
                   ...
                   "5' complete CDS start codon starts with non-N but includes ambiguous nucleotide", # long description
                   0, 0, 0, 0, # always_fails, causes_failure, prevents_annot, misc_not_failure
                   $FH_HR); 
  ...
  vdr_AlertInfoAdd($alt_info_HHR, "ambgcd3c", "feature",
                   ...
                   "3' complete CDS stop codon ends with non-N but includes ambiguous nucleotide", # long description
                   0, 0, 0, 0, # always_fails, causes_failure, prevents_annot, misc_not_failure
                   $FH_HR); 
